Cainiao Tracking API - .Net
================================
Use .Net to track Cainiao shipments with Cainiao Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "CNG00699004559338";
                  createTrackingParams.courierCode = "cainiao";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "CNG00700523490811",
                      courierCode = "cainiao"
                  };
                  ...
                  {
                      trackingNumber = "CNG00690019686337",
                      courierCode = "cainiao"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "CNG00700523490811,CNG00690019686337";
                  getTrackingResultsParams.courierCode = "cainiao";
