Cainiao Tracking API - Go
================================
Use Go to track Cainiao shipments with Cainiao Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    func main() {
      ...
      params := trackingmore.CreateTrackingParams{
        TrackingNumber: "CNG00699004559338",
        CourierCode:    "cainiao",
      }      
...
Update a tracking by ID:
    ...
    func main() {
      ...
      idString := "9bc1cb2286541019f3be73f33c1e82d7"
